...
function PokeAIAgent() {
    ...
    this.decide = function (gameState, options, mySide, forceSwitch) {
    	...
    	//Chooses best action by expected best outcome, unless a switch is forced, then it will decide best switch
...
module.exports.PokAIAgent = PokAIAgent